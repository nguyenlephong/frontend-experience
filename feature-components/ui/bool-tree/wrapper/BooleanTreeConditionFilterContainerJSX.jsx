...
import "./BooleanTree.style.scss";

const BooleanTreeConditionFilterContainerJSX = () => {
  ...
  const onUpdateData = (dataCurrent) => {
  ...
  const onAddNode = (type, nodeCurrent) => {
    let dataCurrent = [...dataMetrics];
  ...
  const renderTreeChildren = (childData, rootId) => {
              ...
              return (<React.Fragment key={item.id}>
                <div className={`wrapper-item-condition item-${item.id}`}>
                  <PropertyConditionFilterBlock
                    ...
                    updateData={(value) => updateData(item.id, value)}
                ...
                <Space size={12}>
                  <Space>
                    ...
                    <div
                      ...
                      onClick={state.disabled ? null : () => setState({enabled: !state.enabled})}>
                  ...
                  <Space>
                    ...
                    <div
                      className={`cdp_switch--label ${state.disabled ? "not-allow" : "pointer"}`}
                      onClick={state.disabled ? null : () => setState({isViewDataStructure: !state.isViewDataStructure})}>
                      Show data structure
                    </div>
                  </Space>
                </Space>
                      ...
                      <div className={"fw"}>
                        {dataMetrics?.map((item, ind) => {
                          ...
                          return (
                            ...
                            <div className={`wrapper-item-condition item-${alias}-${item.id}`}>
                              <PropertyConditionFilterBlock
                                ind={ind}
                                disabled={state.disabled}
                                updateData={(value) => {
...
export default BooleanTreeConditionFilterContainerJSX;
